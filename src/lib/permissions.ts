...
export const ROLE_ROUTES: Record<Role, string[]> = {
  customer: ['/dashboard', '/book', '/search', '/services', '/bookings', '/reviews'],
  provider: ['/provider', '/provider/bookings', '/provider/calendar', '/provider/availability', '/provider/earnings', '/provider/profile', '/provider/documents', '/provider/services', '/provider/analytics', '/provider/quotes', '/provider/payouts'],
