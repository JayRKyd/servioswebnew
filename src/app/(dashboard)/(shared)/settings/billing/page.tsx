  ...
  return (
    <div className="mx-auto max-w-lg space-y-6">
      ...
      <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100 space-y-4">
        ...
        <button className="w-full rounded-lg border border-primary/40 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/[0.06]">+ Add Payment Method</button>
      </div>
